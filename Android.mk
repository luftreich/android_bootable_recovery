...
ifdef I_AM_KOUSH
RECOVERY_NAME := ClockworkMod Touch Recovery
LOCAL_CFLAGS += -DI_AM_KOUSH
else
RECOVERY_NAME := CWM Touch Recovery
endif
...
ifeq ($(BOARD_LDPI_RECOVERY),true)
  ...
  BOARD_RECOVERY_CHAR_WIDTH := 15
  BOARD_RECOVERY_CHAR_HEIGHT := 36
endif
endif
LOCAL_CFLAGS += -DBOARD_RECOVERY_CHAR_WIDTH=$(BOARD_RECOVERY_CHAR_WIDTH) -DBOARD_RECOVERY_CHAR_HEIGHT=$(BOARD_RECOVERY_CHAR_HEIGHT)

BOARD_RECOVERY_DEFINES := BOARD_HAS_NO_SELECT_BUTTON BOARD_LDPI_RECOVERY BOARD_UMS_LUNFILE BOARD_RECOVERY_ALWAYS_WIPES BOARD_RECOVERY_HANDLES_MOUNT BOARD_HAS_SDCARD_INTERNAL

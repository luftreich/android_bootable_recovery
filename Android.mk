...
RECOVERY_VERSION := $(RECOVERY_NAME) v5.0.2.7$(ATRIX_VERSION)
...
ifdef BUILD_CYAN_COLOR
  LOCAL_CFLAGS += -DBUILD_CYAN_COLOR=1
else
ifdef BUILD_GREEN_COLOR
  LOCAL_CFLAGS += -DBUILD_GREEN_COLOR=1
else
ifdef BUILD_DARK_GREEN_COLOR
  LOCAL_CFLAGS += -DBUILD_DARK_GREEN_COLOR=1
else
...
BOARD_RECOVERY_DEFINES := BOARD_HAS_NO_SELECT_BUTTON BOARD_HAS_SMALL_RECOVERY BOARD_LDPI_RECOVERY BOARD_UMS_LUNFILE BOARD_RECOVERY_ALWAYS_WIPES BOARD_RECOVERY_HANDLES_MOUNT BOARD_HAS_SDCARD_INTERNAL BOARD_HAS_INTERNAL_PARTITIONS BOARD_HAS_WEBTOP
